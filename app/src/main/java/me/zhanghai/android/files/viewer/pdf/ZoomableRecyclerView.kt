...
/**
 * @author: archko 2024/10/29 :08:55
 */
open class ZoomableRecyclerView @JvmOverloads constructor(
    context: Context,
    ...
    private inner class ScaleListener : OnScaleGestureListener {
        ...
        override fun onScale(detector: ScaleGestureDetector): Boolean {
            ...
            overScrollMode =
                if (scaleFactor > MIN_ZOOM) OVER_SCROLL_NEVER else OVER_SCROLL_IF_CONTENT_SCROLLS
